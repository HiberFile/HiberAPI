...
export const resetPassword: ResetPassword = {
  ...
  you_asked_for_reset: 'Hai perso la tua password e ci hai chiesto di reimpostarla.',
  if_you_not_asked: 'Se non sei l\'autore di questa richiesta, non cliccare!',
  if_you_asked: 'Se sei l\'autore di questa richiesta,',
  follow_instructions: 'e seguire le istruzioni.'
}
